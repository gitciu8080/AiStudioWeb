...
export default function Home() {
  return <main>
    ...
    <section className="join" id="join"><div className="join-icon"><Zap size={34} strokeWidth={1.5}/></div><p>NEW MEMBERS WANTED</p><h2>下一次站上领奖台的人，<br/>为什么不能是你？</h2><p className="join-copy">欢迎对人工智能、编程与技术竞赛有兴趣的同学。关注信智学院通知，或前往工作室咨询招新安排。</p><div className="qr-placeholder" role="img" aria-label="招新二维码放置位"><div className="qr-frame"><img src="/recruitment-qr.png" alt="人工智能工作室招新群"/></div><strong>扫描进群</strong></div><a className="button primary light-button" href="#top">现在，向前一步 <ArrowUpRight size={19}/></a><br/><span> </span><br/><a className="button primary light-button" href="/招新新群二维码.jpg">点击链接进群 <ArrowUpRight size={19}/></a><div className="join-tags"><span># 不限基础</span><span># 重视行动</span><span># 长期主义</span></div></section>
